...
%IMAGE_ENCODER% Assets\colourTextures.png DataHeaders\Data_Textures.h Data_textures colourTexture
%IMAGE_ENCODER% Assets\pistol.png DataHeaders\Data_Pistol.h Data_pistolSprite sprite
%IMAGE_ENCODER% Assets\shotgun.png DataHeaders\Data_Shotgun.h Data_shotgunSprite sprite
...
%IMAGE_ENCODER% Assets\marine.png DataHeaders\Data_Marine.h Data_marineSprite sprite
